<!-- 幸运大转盘 -->
<template>
  <div class="__big-wheel" ref="bigWheel" :style="{width: props.width, height: props.height}">
    <div class="wrap" :style="{transform: intData.rotateAngle, transition: intData.rotateTransition}">
...
<script lang="ts" setup>
  ...
  const initData = ()=> {
   ...
   const rotate = (index: number) => {
      ...
      const rotateAngle = intData.startRotateDegree + props.turnsNumber * 360 + 360 - (180 / props.prizeList.length + 360 / props.prizeList.length * index) - intData.startRotateDegree % 360
